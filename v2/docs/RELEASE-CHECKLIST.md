...
| E35 | V2.1.0 版本、安装器与发布契约一致性检查 | `VERSION`、后端产品版本、前端 package/lock、安装启动器与候选 ZIP/payload 名称、SBOM 元数据、产品/API/发布文档统一为 V2.1.0；旧 V2.0.0 候选与更新基线历史证据未冒充当前发布证据 |
...
- [x] `update_core.py` 明确标记为不进入 V2.1.0 payload 的非生产未来基线，未宣称在线升级可用。（E2、E3）
