...
:failed
echo.
echo 开机任务已保持禁用，但当前服务未能通过 install_id 身份校验安全停止。
echo 工具没有删除 V2 登记，也没有按端口、进程名或 PID 强制结束任何进程。
