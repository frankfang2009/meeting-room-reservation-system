...
当前仓库状态：V1.0.1 候选版。Mac 自动测试和 Windows GitHub Actions 已通过；
完成真实 Windows 10/11 电脑上的人工验收前，不视为正式发布。
...
- `02_开发工作区/Windows部署目录-V1.0.1-待实机验收`：不含 runtime 和数据的新版候选结构。
...
V1.0.0 正式交付归档。升级包输出目录中仅明确用于实机验收的 V1.0.1 候选 BAT 纳入仓库；
不要把客户安装目录直接复制到仓库。
