...
当前开发主线是 **V2.1.0 全新安装候选**：React 冻结视觉稿、Flask JSON API、SQLite，以及面向 Windows 10/11 的完整离线安装链。
...
自动化通过不等于正式外发。普通用户 Windows 10/11 的 UAC、SmartScreen/EDR、真实重启、计划任务、防火墙、第二台局域网电脑和电视大屏验收完成前，V2.1.0 只能标记为候选版。
