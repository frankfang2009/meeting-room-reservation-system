...
> 审查范围、修复依据和勾选结果，不是 V2.5.1 当前任务书。不要重新执行其中的旧分支、
> HEAD、E 编号或发布步骤，也不要把未勾选的后续构想当作 V2.5.1 当前缺陷。
> 当前产品真值见 `v2/docs/PRODUCT-CONTRACT.md`；当前发布门禁与 Windows 验收入口见
> `v2/docs/RELEASE-CHECKLIST.md`。V2.5.0 实机指南只作历史证据。
>
